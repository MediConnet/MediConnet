...
import { useReceptionMessages } from "../../association/hooks/useReceptionMessages";
        ...
        <CardContent>
                    ...
                    <Box key={message.id}>
                      ...
                      >
                        ...
                        >
                          <Avatar
                            sx={{
                              bgcolor: isDoctor ? "primary.main" : "secondary.main",
                              width: 32,
                              height: 32,
                            }}
                          >
                            {isDoctor ? <Person /> : <MessageIcon />}
                          </Avatar>
                          <Box
                            sx={{
                              bgcolor: isDoctor ? "primary.main" : "grey.200",
                          ...
                          >
                            <Typography variant="caption" sx={{ display: "block", mb: 0.5, opacity: 0.8 }}>
                              {message.senderName || (isDoctor ? "Tú" : "Recepción")}
                            </Typography>
          ...
          <Box sx={{ display: "flex", gap: 1 }}>
            <TextField
              ...
              multiline
              maxRows={3}
              placeholder="Escribe un mensaje a la recepción..."
              value={messageText}
