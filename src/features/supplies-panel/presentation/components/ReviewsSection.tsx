...
import { useSupplyPanelReviews } from "../hooks/useSupply";
          ...
          {reviews.map((review) => (
            ...
            >
              <div className="flex items-start justify-between mb-2">
                <div>
                  <p className="font-medium text-gray-800">{review.userName || 'Usuario'}</p>
                ...
                <span className="text-xs text-gray-500">
                  {new Date(review.createdAt || review.date).toLocaleDateString('es-MX')}
                </span>
              </div>
              {review.comment && (
