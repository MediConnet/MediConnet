        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h3 className="text-xl font-bold text-gray-800">Anuncios Promocionales</h3>
              <p className="text-sm text-gray-500 mt-1">
                Tu solicitud fue aprobada. Ahora puedes crear tu anuncio
              </p>
            </div>
            <button
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
            ...
            <p className="text-sm text-gray-600 mt-2">
              Tu solicitud ha sido aprobada. Haz clic en "Crear anuncio" para publicar tu promoción.
            </p>
          </div>
        </div>
    ...
    <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
      <div className="flex items-center justify-between mb-4">
        <div>
          <h3 className="text-xl font-bold text-gray-800">Anuncios Promocionales</h3>
          <p className="text-sm text-gray-500 mt-1">
            Solicita permiso para crear anuncios promocionales
          </p>
        </div>
        <button
          onClick={() => setIsCreateAdModalOpen(true)}
        ...
        >
          ...
          <span className="text-sm font-medium">
            {isCreating ? "Enviando..." : "Solicitar permiso"}
          </span>
        </button>
      </div>
      ...
      <div className="flex flex-col items-center justify-center py-16">
        ...
        <p className="text-sm text-gray-500 text-center max-w-md">
          Para crear un anuncio promocional, primero debes solicitar permiso al administrador. 
