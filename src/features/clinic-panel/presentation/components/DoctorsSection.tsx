...
import { Add, Email, Link, Edit, ToggleOn, ToggleOff } from "@mui/icons-material";
...
export const DoctorsSection = ({ clinicId }: DoctorsSectionProps) => {
  const { doctors, loading, inviteDoctor, toggleStatus, assignOffice } = useClinicDoctors(clinicId);
